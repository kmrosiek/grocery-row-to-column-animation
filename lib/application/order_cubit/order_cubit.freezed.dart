...
class _$OrderStateImpl implements _OrderState {
  const _$OrderStateImpl({required final List<OrderItem> orderItems})
  ...
  @override
  String toString() {
    return 'OrderState(orderItems: $orderItems)';
  }
...
abstract class _OrderState implements OrderState {
  const factory _OrderState({required final List<OrderItem> orderItems}) =
      _$OrderStateImpl;
